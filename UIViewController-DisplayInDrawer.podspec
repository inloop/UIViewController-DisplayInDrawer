...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of UIViewController-DisplayInDrawer.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'vilemkurz' => 'vilem.kurz@cocoaminers.com' }
  s.source           = { :git => 'https://github.com/vilemkurz/UIViewController-DisplayInDrawer.git', :tag => s.version.to_s }
